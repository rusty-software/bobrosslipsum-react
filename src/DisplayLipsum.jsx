...
const quotes = [
  ...
  // Series 1, Episode 6
  "You want to start in the center and work outward.",
  "We don't want this to get too bright.",
  "Just work it around and around and all the way out to the edges.",
  "Very gently, we'll bring this together.",
  "We push quite hard!",
  "Sneaky cloud running around here at night!",
  "This is unplanned -- it really just happens.",
  "Just a little blue.",
  "This is a very delicate touch... a very light touch.",
  "I may have to go find my old mukluks and put 'em on!",
  "If you've been in Alaska for less than a year, you're a cheechako!",
  "Each time you do it, you learn from it -- you progress!",
  // Series 1, Episode 7
  "I hope you have a canvas set up on your almighty easel, and a cool drink at hand, and let's go here!",
  "We'll bring this down to about like so.",
  "Already we have a masterpiece for a museum of modern art somewhere.",
  "Just so you have it nice and blended.",
  "Just give it a little hue here.",
  "Gently, gently, gently blend that together.",
  "Very, very easy to overwork them.",
  "All we want to leave is the value in the canvas.",
  "Let's diffuse the bottom of it.",
  "Super light touch here.",
  "Now we can start coming forward.",
  "You can take your time and put in all the little fantastic details that you want to back here.",
